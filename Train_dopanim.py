...
if args.annotator == 'two_annotators':
    annotators = ['rand_label1', 'rand_label2']
    mv_annotator = 'mv_label'
elif args.annotator == 'three_annotators':
    annotators = ['rand_label1', 'rand_label2', 'rand_label3']
    mv_annotator = 'mv_label'
elif args.annotator == 'four_annotators':
    annotators = ['rand_label1', 'rand_label2', 'rand_label3', 'rand_label4']
    mv_annotator = 'mv_label'
else:
...
loader = dataloader.dopanim_dataloader(batch_size=args.batch_size, num_workers=5, root=args.data_path)
