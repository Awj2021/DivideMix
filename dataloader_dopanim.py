...
class dopanim_dataloader():  
    ...
    def run(self,mode,annotator,pred=[],prob=[],paths=[]):        
        if mode=='warmup':
            warmup_dataset = dopanim_dataset(self.root, self.noise_file,transform=self.transform_train, mode='all', annotator=annotator)
            ...
            labeled_dataset = dopanim_dataset(self.root, self.noise_file, transform=self.transform_train, mode='labeled',pred=pred, probability=prob, paths=paths, annotator=annotator)
            labeled_loader = DataLoader(
                ...
                num_workers=self.num_workers,
                drop_last=True)           
            unlabeled_dataset = dopanim_dataset(self.root,self.noise_file, transform=self.transform_train, mode='unlabeled',pred=pred, probability=prob,paths=paths, annotator=annotator)
            ...
            eval_dataset = dopanim_dataset(self.root, self.noise_file, transform=self.transform_test, mode='all', annotator=annotator)
