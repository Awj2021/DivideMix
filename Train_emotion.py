...
parser.add_argument('--project_name', default='dopanim-training', type=str, help='name of the wandb project.')
...
def test(net1,net2,test_loader):
    ...
    # Store accuracies for the last 5 epochs
    ...
    # Calculate average of the last 5 epochs
    ...
    wandb.log({"test_acc_wo_sf": acc, "test_acc_w_sf": acc_w_sf, "test_loss": test_loss, 
               "avg_test_acc_wo_sf": avg_acc, "avg_test_acc_w_sf": avg_acc_w_sf, "epch": epoch}) if args.wandb else None
...
if args.dataset == 'flickr':
    loader = dataloader_flickr.flickr_dataloader(root=args.data_path, noise_file=args.noise_file, batch_size=args.batch_size, num_workers=5, annotator=args.annotator)
elif args.dataset == 'twitter':
    loader = dataloader_twitter.twitter_dataloader(root=args.data_path, noise_file=args.noise_file, batch_size=args.batch_size, num_workers=5, annotator=args.annotator)
else:
...
for epoch in range(args.num_epochs+1):   
    ...
    if epoch<args.warm_up_epochs:     # warm up  
