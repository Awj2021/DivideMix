...
CUDA_VISIBLE_DEVICES=0 python Train_chaoyang.py --data_path ./chaoyang --project_name chaoyang_baseline_single_label --dataset chaoyang --num_epochs 100 --batch_size 32 --lr 0.002 --warm_up_epochs 1 --cosine --num_class 4 --lambda_u 0 --annotator label_B --wandb