...
annotator=$1
$python Train_cifar.py --data_path ./cifar-10-batches-py --project_name cifar10_dividemix_two_annotators --dataset cifar10 --gpuid 0 --num_epochs 300 --batch_size 64 --lr 0.02 --warm_up_epochs 10 --cosine --lambda_u 0 --wandb --annotator $annotator
