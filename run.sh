...
CUDA_VISIBLE_DEVICES=1 python Train_cifar.py --data_path ./cifar-10-batches-py --project_name cifar10_dividemix  --dataset cifar10 --gpuid 0 --batch_size 64 --lr 0.02
