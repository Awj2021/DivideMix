...
lambda_u=$1
$python Train_cifar.py --data_path ./cifar-10-batches-py --project_name cifar10n_dividemix_test_lambda_u --dataset cifar10 --gpuid 0 --num_epochs 600 --batch_size 128 --lr 0.02 --warm_up_epochs 30 --wandb --cosine --lambda_u $lambda_u
